const CONFIG = {
  ...
  FEATURES: [
    { title: "Artikel Informatif", desc: "teknologi, bisnis, dan pengembangan diri", icon: "fa-newspaper" },
    { title: "Portfolio Mengesankan", desc: "proyek dan karya terbaik saya", icon: "fa-briefcase" },
    { title: "Konsultasi Digital", desc: "berdiskusi tentang strategi online Anda", icon: "fa-comments" },
    { title: "Kolaborasi Kreatif", desc: "wujudkan ide-ide luar biasa bersama", icon: "fa-handshake" }
  ],
  TIMEZONE: 7 // WIB
};
